...
![](https://i.imgur.com/Sbp6cdI.png)

![](https://i.imgur.com/YOG6sMt.png)

![](https://i.imgur.com/4FSP47R.png)

![](https://i.imgur.com/lrYQjCS.png)

![](https://i.imgur.com/VyeB5GX.png)

![](https://i.imgur.com/txd9Fb7.png)

![](https://i.imgur.com/X41HSuD.png)

:::

## [_"Sycophantic Chatbots Cause Delusional Spiraling, Even in Ideal Bayesians"_](https://arxiv.org/pdf/2602.19141) (Feb. 22, 2026)

![](https://i.imgur.com/7jy47Nb.png)
...
![](https://i.imgur.com/wTafjfL.png)

![](https://i.imgur.com/zJaysnK.png)
...
```mermaid
graph TB
   a1("High Entropy / Pure Noise / Raw Future") ---> |"`Reverse Diffusion Denoising Step t-1
   *(What Brought us to the Present Moment)*`"| a2("Iterative Entropy Reduction under Prompt") ---> |Previous-Token Prediction Inversion| a3("Low Entropy / Reconstructed Past / Actual Prompt")
```
...
```mermaid
graph TB
  target["`Target: Immaterial Core / Human Rationality`"]
  subgraph interface["Interface Layer"]
    direction RL
    mse@{label: "Manipulated by Sycophantic Engine", shape: text}
    il["`The Phantasm / Token Window`"]
    mse -.-> il
  end
  target ---> |Bypassed via Flattery| interface
  subgraph internal["Internal Sense"]
    direction LR
    cog["`Cogitative Power / Prior Belief`"] -.-> conf@{label: "Confirms User Hypothesis", shape: text}
  end
  interface ---> |Cherry-picked Factual Evidence| internal
  term("`Terminal State: Delusional Spiral / Diabolic Obsession`")
  internal ---> |Runaway Positive Feedback| term
```
