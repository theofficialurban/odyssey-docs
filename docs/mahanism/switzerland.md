...
## _Urban & [Juxtaposition1](https://juxtaposition1.substack.com?r=3kr5wz) on the BIS_

:::tip Playlist
Please also be sure to view the playlist: https://youtube.com/playlist?list=PLeZ164ZSzHezWNaaDhC-EXTOfhe6RV6Vg&si=8iXwdM8tjq7iT2vO by [@HomieLand--Sickurity](https://www.youtube.com/@HomieLand--Sickurity) on YouTube.
:::
...
<VEmbed src="https://rumble.com/embed/v70aupe/?pub=3gc1h8" platform="Rumble" />

:::caption
https://rumble.com/v72hipm-urban-odyssey-live.html?mref=3gc1h8&mc=7m5w3
:::
...
<VEmbed src="https://rumble.com/embed/v70laqy/?pub=3gc1h8" platform="Rumble" />

:::caption
https://rumble.com/v72ryr6-urban-and-juxtaposition1-ep.-03-live.html?mref=3gc1h8&mc=7m5w3
:::

::::

## Videos by `HomieLand--Sickurity`

:::details Expand for Videos
...
<YouTube id="BOQO5v0Mz8Y" />

:::

## Deep Dive Article

<Card title="Tower of Basel: Nazi Gold & the Untouchable Central Bank [Adam Lebor]" img="https://substackcdn.com/image/fetch/$s_!B_oe!,w_1200,h_600,c_fill,f_jpg,q_auto:good,fl_progressive:steep,g_auto/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F3a4bb82f-c093-4476-a37e-9a20594d2c90_1456x1048.png" description="Listen now | This text offers a great amount of information about the history and backstory of the Bank for International Settlements including the early years and some of its international dealings." href="https://theofficialurban.substack.com/p/tower-of-basel?r=3kr5wz" />

## BIS Untouchable & Infalliable

:::warning Very Important Point
**Similar to the [United Nations](https://en.wikipedia.org/wiki/United_Nations "United Nations"), the [IRCRCM](https://en.wikipedia.org/wiki/International_Red_Cross_and_Red_Crescent_Movement "International Red Cross and Red Crescent Movement"), or the [IMF](https://en.wikipedia.org/wiki/International_Monetary_Fund "International Monetary Fund"), the BIS has a special status. Employees in the financial sector are granted immunity and may not be searched. The building and all its parts also play a special role. The building and grounds are treated similarly to an [embassy](https://en.wikipedia.org/wiki/Diplomatic_mission "Diplomatic mission") and are invulnerable (Swiss usage) or inviolable (German usage). It is part of Swiss territory, but national sovereignty can only be enforced to a limited extent.**

**Swiss authorities have access only if the President or CEO of the BIS grants permission and waives the principle of territorial inviolability. This circumstance is often colloquially referred to in the press as [extraterritorial](https://en.wikipedia.org/wiki/Extraterritoriality "Extraterritoriality") status, which is somewhat simplified but not entirely legally correct. This special status is governed by an agreement, which entered into force on January 1, 1987, between the BIS and the [Swiss Federal Council](<https://en.wikipedia.org/wiki/Federal_Council_(Switzerland)> "Federal Council (Switzerland)").[4](https://en.wikipedia.org/wiki/BIS_Tower#cite_note-4) The agreement has its origins in an agreement concluded at the [Hague Conference](https://en.wikipedia.org/wiki/Hague_Conference_on_Private_International_Law "Hague Conference on Private International Law") on January 20, 1930.  Access by Swiss authorities, including the police, requires the authorization of the President or General Manager of the BIS.**
:::

![1881 illustration depicting papal infallibility](https://i.imgur.com/HXjzkL2.png)

The church teaches that infallibility is a [charism](https://en.wikipedia.org/wiki/Charism "Charism") entrusted by Christ to the whole church, whereby the Pope, as "head of the college of bishops", enjoys papal infallibility.[^1] This charism is the supreme degree of participating in Christ's divine authority, [^2] which, in the [New Covenant](https://en.wikipedia.org/wiki/New_Covenant "New Covenant"), so as to safeguard the faithful from defection and guarantee the profession of faith, ensures the faithful abide in the truth. [^3]  The church further teaches that divine assistance is also given to the Pope when he exercises his ordinary [Magisterium](https://en.wikipedia.org/wiki/Magisterium "Magisterium")

## Images {#images}

:::details Expand for Images

[Exterior of the Bank for International Settlements]{.text-2xl .text-transparent .bg-clip-text .bg-gradient-to-r .from-orange-400 .to-yellow-600 .py-3}
![Exterior of the Bank for International Settlements](https://i.imgur.com/JGyMszp.jpeg)

[Exterior 2]{.text-2xl .text-transparent .bg-clip-text .bg-gradient-to-r .from-orange-400 .to-yellow-600 .py-3}
![Exterior 2](https://i.imgur.com/mgPLnVk.jpeg)

[Exterior 3]{.text-2xl .text-transparent .bg-clip-text .bg-gradient-to-r .from-orange-400 .to-yellow-600 .py-3}
![Exterior 3](https://i.imgur.com/v5Xonye.jpeg)

[Other Buildings]{.text-2xl .text-transparent .bg-clip-text .bg-gradient-to-r .from-orange-400 .to-yellow-600 .py-3}
...
![Schematics](https://i.imgur.com/jCjMoOe.png)

[Tower of Babel, Quantum Computers, Bank for International Settlements]{.text-2xl .text-transparent .bg-clip-text .bg-gradient-to-r .from-orange-400 .to-yellow-600 .py-3}
![Tower of Babel, Quantum Computers, Bank for International Settlements](https://i.imgur.com/FBfnFV0.jpeg)

[Maps from the Deep State Mapping Project: https://dsmp.io/?aff=22]{.text-xl .text-transparent .bg-clip-text .bg-gradient-to-r .from-orange-400 .to-yellow-600 .py-3}
![Maps from the Deep State Mapping Project: https://dsmp.io/?aff=22](https://i.imgur.com/mJ0hBcB.png)

![Maps from the Deep State Mapping Project: https://dsmp.io/?aff=22](https://i.imgur.com/7gwvMf5.png)
...
:::highlight
_“The Bank is completely removed from any governmental or political control.”_
:::
...
1. **European Payments Union:** In the 1950s, the BIS managed this system, which internationalized the continent's payment system and was a critical step in rebuilding post-war trade.
2. **The "Snake":** During the 1970s, the BIS ran this mechanism that held European currencies in fixed exchange rate bands, a precursor to a single currency.
3. **Path to the Euro:** In the 1980s, the BIS hosted the Delors Committee. This committee's report laid out the definitive path to European Monetary Union and the adoption of the euro.
4. **Birth of the ECB:** The BIS midwifed the European Monetary Institute (EMI), the forerunner to the European Central Bank (ECB). The EMI's president was Alexandre Lamfalussy, the "Father of the euro," who had previously served as the general manager of the BIS.
...
His secretary, Clara Steffeck, provided a vivid portrait of his intense, minimalist working style, noting that he spent his days in a spartan office phoning across the world and smoking, dictating no letters but remaking the German economy. Schacht was a master of financial psychology, operating on a simple but powerful principle: the _appearance_ of financial stability is what creates monetary value. If people _believed_ the currency was stable and that a firm hand was in control, the currency would gain value. It was this insight that allowed him to restore order from chaos.
...
The defining test of the BIS's wartime ethos came in March 1939 with the transfer of Czechoslovak gold. After the Nazis marched into Prague, the German Reichsbank forced the directors of the Czech National Bank to issue two orders. The first was to transfer 23.1 metric tons of gold—held in a BIS account at the Bank of England—to the Reichsbank's BIS account. The second was to transfer nearly 27 metric tons of gold held in the National Bank of Czechoslovakia's _own direct account_ at the Bank of England.
...
:::highlight
_"...he was very doubtful that he would have thought it his duty, as Director of the BIS, to make a statement about its transactions to the British government."_
:::
...
:::highlight
_"My God. If you’re right, we’ve lost the war."_
:::
...
1. **1930s:** Joined the BIS with express instructions from the Reichsbank to undermine the German reparations process from within.
2. **WWII:** Became a director at the Reichsbank, a member of the Nazi party, and served on the board of Kontinental-Öl, a firm notorious for using slave labor from concentration camps.
3. **Post-WWII:** Was "whitewashed" from Allied blacklists with the help of Allen Dulles and placed on a list of approved Germans to help run the new administration.
4. **1958:** Appointed the first president of the new German central bank, the **Bundesbank**, and promptly returned to the governors' meetings at the BIS in Basel.
...
- **Hjalmar Schacht:** Described by _The New York Times_ as "The Iron-Willed Pilot of Nazi Finance," Schacht was the President of the Reichsbank who almost single-handedly stabilized Germany's hyper-inflated currency in 1923. He did so not with gold, but with the creation of the _rentenmark_, a currency backed only by the value of Germany's land and holdings. Schacht brilliantly understood the psychology of money: if people believed the currency had value, then it would be valued. The appearance of stability created monetary value. A brilliant and imperious figure, he skillfully maneuvered to have the BIS established and proudly referred to it as "my bank."
...
The second order, issued under the same duress, was for the transfer of nearly 27 metric tons of gold held in the National Bank of Czechoslovakia's _own_ account at the Bank of England. This transfer, however, did not go through. It was stopped by the direct political intervention of Sir John Simon, the British Chancellor of the Exchequer, who blocked all direct Czechoslovak assets. This crucial contrast demonstrates that political will could, and did, halt the plunder. The successful processing of the first transfer was therefore not an inevitability but a specific and egregious failure of governance on the part of the BIS and the Bank of England, which chose to honor a request they knew was made under threat of death.
