...
# PHCENICIAN ORIGIN OF THE BRITONS, SCOTS &: ANGLO-SAXONS (Laurence Waddell, 1924) {#title}

[[toc]]

## Overview

![](https://i.imgur.com/GfJaGvh.png)
...
<Card title="The Phoenician Origin of Britons, Scots & Anglo-Saxons" img="https://archive.org/services/img/ThePhoenicianOriginOfBritonsScotsAnglo-saxons1924-1st.Edition" description="Discovered by Phoenician & Sumerian Inscriptions in Britain, by Pre-Roman Briton Coins & a Mass of New History. (1924 - 1st. edition, By Laurence Austine WADDELL)" href="https://archive.org/details/ThePhoenicianOriginOfBritonsScotsAnglo-saxons1924-1st.Edition" />

## **The Solar Roots of Britain: _A Primer on Ancient National Symbolism_**
...
1. **Aryan-Phoenician:** A semi-cursive script written from left to right.
2. **Ogam:** A sacred, linear "tree-twig" script used by the early Scots and Britons.
...
1. **Light of the World:** Representing the illumination of the human intellect and divine guidance.
2. **The Fire-Offering:** A reference to the sacred **"Bel-fire"** rites and the production of **"Need-fire"** by friction, a practice that survived in Britain for centuries.
3. **Divine Victory:** An emblem of the Father-God’s triumph over the powers of chaos and darkness.
...
## **From Asia Minor to Albion: _The Epic Voyage of the Phoenician Mariners_**
...
1. **Departure from Cilicia:** Launching from ports like Tarsus with fleets of "winged galleys" carrying families, livestock, and sacred Fire.
2. **Staging in Spain (Gades/Cadiz):** Establishing the "House of the Gads" (Gades) as a defensive mercantile seaport outside the Mediterranean.
3. **The Northern Circuit:** Navigating the "Pillars of Hercules" and sailing around the Orkney Islands to reach the northern coasts of "Albion."
4. **Colonization of the Isles:** Formal establishment of settlements in Scotland, Ireland, and England, seeking "a small part of Britain to dwell in."
...
1. **Civilization over Savagery:** The original Britons were literate, seafaring Aryans from the Hittite/Phoenician stock, arriving with a sophisticated culture over a millennium before Rome.
2. **The Solar Blueprint:** Modern national symbols—Britannia, the Union Jack, and the St. George’s Cross—are ancient Aryan Phoenician emblems of the Sun-Fire.
3. **Linguistic Footprints:** Geography is a living history book; names like Caithness, Selsey, and Dun-Barton are permanent records of the "Barat" migration path.

## **The Phoenician-Aryan Nexus: _A Philological Re-evaluation of British Etymology and Migration_**
...
| ----------------- | --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Personal Name** | **Ikar (Ixar)**                   | Corresponds to the "Western Land" (_Akharri_) of the Amorites; a marker of westward Kassi/Hittite migration.                                           |
...
| **Tribal Title**  | **Kazzi (Qass)**                  | Uses the "Z" form found in Northwest Semitic (e.g., _Zidon_ for _Sidon_), latterly softening into the British "Cassi/Catti" via dental-sibilant shift. |
...
The persistence of tribal markers across millennia serves as the most rigorous proof of ethnic continuity. The transition of the title "Barat" (Vedic _Brihat_) into "Brit-on" is a structural evolution underpinned by the Sumerian linguistic substrate.

- **The** _**Ana**_ **Suffix:** The formation of "Brit-on" relies on the Sumerian suffix _-ana_, meaning "one" or "individual." The compound "Barat-ana" (One of the Barats) is the linguistic fossil preserved in the Scottish "ane" and the Roman "Brit-anni." This is an aggressive marker of ethnic identity, parallel to "Rajput-ana."
...
- **Vedic Nuance:** It is critical to note that the early Pali form _Khattiyo_ is the pure Hittite ethnic marker; the later Sanskrit _Kshatriya_ contains an intrusive "r," representing a secondary Sanskritization of the original Aryan root.

| Ancient Hittite (Xatti/Khatti)         | Vedic/Pali (Khattiyo)                             | Pre-Roman British (Catti/Cassi)                 | Modern Scottish (Scot/Xat)            |
| -------------------------------------- | ------------------------------------------------- | ----------------------------------------------- | ------------------------------------- |
| The ruling race of Cappadocia/Cilicia. | The "noble" caste (Intrusive 'r' in _Kshatriya_). | Title stamped on British coinage (_Cas_ coins). | Dialectic survival of the _Xat_ root. |
...
The technical phonology of this transition is best observed in the dropping of initial gutturals—a process of lenition. For example, the Hittite word for a porticoed palace or hall, _Khilaani_ (or _Xilaani_), underwent a specific shift:

1. **Khilaani/Xilaani** (Hittite/Sumerian)
2. **Geleoin** (Irish-Scot clan title)
3. **Uchlani** (The "dropping of the initial guttural G" as noted in Ptolemy’s British tribal titles)
4. **Wallon** (The palatalized final form, seen in the king-title _Cad-wallon_).
...
1. **Numerical Parallels:** The letter "I" consists of five perpendicular strokes in both the Ogam script and the primitive linear Sumerian signs—a "smoking gun" of unilateral transfer.
2. **Solar Patterns:** The "tree-twig" patterns represent the sacred fire-sticks used in Sun-cult rituals.
