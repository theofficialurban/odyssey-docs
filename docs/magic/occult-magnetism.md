---
title: Animal Magnetism & Mesmerism
description: |
  These are old occult texts on Magnetism, Animal Magnetism, Hypnosis and Mesmerism which I further connect to Plasmas and Ken Wheeler's framework of Dielectro-Electromagnetism.
tags:
  - Mermaid Charts
  - Animal Magnetism
---
...
== PLASM
![](https://i.imgur.com/BhdhPMJ.png)
https://webstersdictionary1828.com/Dictionary/Plasma
== PLASMA
![](https://i.imgur.com/Tu6dUe9.png)
[https://webstersdictionary1828.com/Dictionary/Plasma](https://webstersdictionary1828.com/Dictionary/Plasma)

![](https://i.imgur.com/M7K4KYJ.png)
[https://www.websters1913.com/words/Plasma](https://www.websters1913.com/words/Plasma)

![](https://i.imgur.com/fcH8lpP.png)
== THESAURUS
![](https://i.imgur.com/45PN6Yk.png)

![](https://i.imgur.com/ThQPu3p.png)

![](https://i.imgur.com/oFCe0Dd.png)

![](https://i.imgur.com/22t5iwC.png)

![](https://i.imgur.com/NplOROV.png)

![](https://i.imgur.com/92TEIra.png)

![](https://i.imgur.com/tYkSm0A.png)

![](https://i.imgur.com/PQ0wZjN.png)
...
```mermaid
mindmap
  root((The Prime Field Critique))
    a("`**Anderson's 1895 Fallacy**`")
      ma("`Believes in 'Magnetic Attraction'`")
      Electricity as the Highest Leading Element
      Adheres to Conventional North South Magnetic Polarity
    w("`**Wheeler's 2014 Correction**`")
      w1(Attraction is a Perceptual Illusion Driven Solely by Dielectrical Voidance)
      Electricity is a Hybrid Byproduct Dielectricity is the Absolute Prima Causa
      Poles are Spatial Illusions of Clockwise vs Counterclockwise Spinning Vortexes
```
...
```mermaid
flowchart TB
  s0@{shape: circle, label: "**The Counterspace** (Kha / 0)<br />(Unmanifest Inertia & Infinite Potential)"} ---> |Torsional Disruption of Stillness| s1@{shape: bang, label: "**The Discharge**<br />(Magnetism & Circular Polarization)"} ---> |Fabrication of 3D Metrics| s2@{shape: rounded, label: "Physical Space"}
...
![Victrola](https://images.squarespace-cdn.com/content/v1/5e62fc6bb51b7a5a8815caf3/fd1e6960-3fdb-4aec-98bf-82c12b6e1d0f/Victrola.jpg)
...
```mermaid
graph TB
  classDef animate stroke-dasharray: 6,5,stroke-dashoffset: 900,animation: dash 45s linear infinite;
  classDef ether stroke-dasharray: 4,7,fill:#b3a8ff12,font-family:Alegreya,font-weight:900;

  ce["THE COSMIC ETHER (Psi / Ψ / Universal Stasis)"]:::ether ---> |Enters biology via the respiratory gate| ap@{label: "THE ARISTOTELIAN PNEUMA (Aetheric Gas)", shape: flag} ---> |Condensed inside the blood-vascular grid| cb["THE COLD BIOPLASMA MATRIX"]
  san@{label: "Conductive subatomic network of the Biofield", shape: text}
  cb ---> san
  bpl("`**BIOPHOTON LEAKAGE**
  *(Coherent ultraviolet light emission)*`")
  nel("`**NEURAL ELECTRICITY**
  *(Transduced physical sensation)*`")
  san e1@<-.-> bpl
  san e2@<-.-> nel
  class e1 animate
  class e2 animate
...
```mermaid
mindmap
  root((THE OPERATOR'S WILL))
    h("HYPNOTISM (Braidism)")
      Operates via verbal Suggestion.
      The Operator is merely an "idea" in the subject's mind.
      Chokes and dazes the brain centers, destroying equilibrium.
      Purely subjective; limits the subject as an animal machine.
    m("MESMERISM (Odic Force)")
      Operates via real Magnetic Current.
      The Operator is the active driver projecting a vital fluid
      Establishes a true "Magnetic Touch" linking mind-to-mind
      Enhances psychic powers, enabling the ego to manifest with freedom
```
...
![Convexity](https://i.imgur.com/8Diqymc.png)
